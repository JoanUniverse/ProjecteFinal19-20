    ...
    public class RequestAsync extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                return RequestHandler.sendGetToken(RequestHandler.GET_ALL_FORUMS, preferences.getUserToken());
            }
            catch(Exception e){
    ...
    public class RequestAsyncStats extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            try {
                //GET Request
                HashMap<String, String> p = new HashMap<String, String>();
                return RequestHandler.sendGetToken(RequestHandler.GET_CSGO_STATS + preferences.getLastPlatfornID(),preferences.getUserToken());
            }
            catch(Exception e){
                return new String("Exception: " + e.getMessage());
            }
    ...
    public class RequestAsyncPostStats extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                return RequestHandler.sendPostToken(RequestHandler.UPDATE_CSGO_STATS,postDataParams,preferences.getUserToken());
            }
            catch(Exception e){
                return new String("Exception: " + e.getMessage());
            }
