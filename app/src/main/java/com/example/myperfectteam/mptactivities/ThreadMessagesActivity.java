...
import com.example.myperfectteam.mptactivities.CsgoPlayerStatsActivity;
import com.example.myperfectteam.mptactivities.DeleteMessageActivity;
import com.example.myperfectteam.mptactivities.LoginActivity;
import com.example.myperfectteam.mptactivities.ThreadListActivity;
    ...
    public class RequestAsync extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                return RequestHandler.sendPostToken(RequestHandler.GET_ALL_MESSAGES, p, preferences.getUserToken());
            } catch (Exception e) {
    ...
    private void showMessages() {
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int playerMessageID = message.getPlayerID();
                int playerID = preferences.getLastPlayerID();
                if (playerID == playerMessageID) {
                    Intent intent = new Intent(getApplicationContext(), DeleteMessageActivity.class);
                    intent.putExtra("messageID", messageID);
                    intent.putExtra("playerMessageID", playerID);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(getApplicationContext(), "You can't delete others messages!", Toast.LENGTH_LONG).show();
                }
                return true;
            }
        });
    ...
    public class RequestAsyncSendMessage extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                return RequestHandler.sendPostToken(RequestHandler.SEND_MESSAGE, p, preferences.getUserToken());
            } catch (Exception e) {
                return new String("Exception: " + e.getMessage());
            }
        }
